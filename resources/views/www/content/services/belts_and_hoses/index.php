...
return [
    ...
    'services' => [
        'heater_hose_replacement' => [
            'title' => 'Heater Hose Replacement',
            'desc' => 'Heater hoses play a crucial role in a vehicle’s heating system, which operates in conjunction with the cooling system',
            'file' => 'heater_hose_replacement'
        ],
        'radiator_hose_replacement' => [
            'title' => 'Radiator Hose Replacement',
            'desc' => 'Your car or truck’s radiator hoses, which connect the engine to the radiator, are important components that maintain',
            'file' => 'radiator_hose_replacement'
        ],
        'serpentine_belt_replacement' => [
            'title' => 'Serpentine Belt Replacement',
            'desc' => 'As the timing belt synchronizes engine processes, the serpentine belt powers peripheral processes in the engine compartment',
            'file' => 'serpentine_belt_replacement'
        ],
