...
return [
    ...
    'services' => [
        'air_conditioning_system_diagnostic' => [
            'title' => 'Air Conditioning System Diagnostic',
            'desc' => 'Your vehicle’s air conditioning system cools, purifies, and circulates air throughout the vehicle to promote a comfortable cabin environment and',
            'file' => 'air_conditioning_system_diagnostic'
        ],
        'air_conditioning_system_service' => [
            'title' => 'Air Conditioning System Service',
            'desc' => 'Car air conditioning systems promote a comfortable cabin interior and help prevent driver fatigue. During normal vehicle operation',
            'file' => 'air_conditioning_system_service'
        ],
        'heating_system_diagnostic' => [
            'title' => 'Heating System Diagnostics',
            'desc' => 'Your vehicle’s heating system absorbs excess engine heat through a coolant—a mixture of water and antifreeze. Hoses carry',
            'file' => 'heating_system_diagnostics'
        ],
