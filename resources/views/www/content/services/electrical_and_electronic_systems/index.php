...
return [
    ...
    'sections' => [
        ...
        1 => [
            'title' => 'Benefits',
            'desc' => 'If your vehicle experiences an electrical or electronic systems failure, it is beneficial to have the problem repaired quickly. A vehicle with electrical problems may not start, or it may become inoperative. Our experts are able to diagnose and repair problems during an electrical and electronic systems service. We can locate shorts, grounds, open, and resistance problems in electrical and electronic circuits, and we can repair wiring harnesses and connectors along with electrical wiring and solder repair. Our staff is also able to diagnose the cause of uneven headlight brightness, intermittent lights, dim lights, and inoperative lights. In addition, we can service headlights and bulbs as well as correct intermittent turning signal and hazard light operation. Motor-driven accessory circuits, heated glass operation, and electric lock operation are all concerns for our staff as we begin to diagnose the electrical and electronic issue. In the end, our staff will work hard to get you driving a safe and functional vehicle again.'
        ]
    ],
    'services' => [
        'dashboard_warning_diagnostic' => [
            'title' => 'Dashboard Warning Diagnostic',
            'desc' => 'The dashboard warning system is an effective tool that alerts you to one or more problems with your vehicle',
            'file' => 'dashboard_warning_diagnostic'
        ],
        'headlight_bulb_replacement' => [
            'title' => 'Headlight Bulb Replacement',
            'desc' => 'Headlight bulbs provide visibility for drivers and alert both pedestrians and other motorists to a vehicle’s presence',
            'file' => 'headlight_bulb_replacement'
        ],
        'interior_and_exterior_lighting_replacement' => [
            'title' => 'Interior & Exterior Lighting Replacement',
            'desc' => 'Many modern vehicles are equipped with a wide selection of interior and exterior lights for the convenience and safety of occupants',
            'file' => 'interior_and_exterior_lighting_replacement'
        ],
        'power_locks_repair' => [
            'title' => 'Power Locks Repair',
            'desc' => 'Since being introduced in 1914, power door locks have increased convenience and safety for drivers and passengers',
            'file' => 'power_locks_repair'
        ],
        'power_sunroof_repair' => [
            'title' => 'Power Sunroof Repair',
            'desc' => 'The sunroof is a horizontal panel, usually made of glass, located on a vehicle’s roof. Primarily, sunroofs provide personal enjoyment',
            'file' => 'power_sunroof_repair'
        ],
        'power_window_repair' => [
